                ...
                try {
                    switch (no) {
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            System.out.print("Укажите id модели которую хотите удалить : ");
                            if (scanner.hasNextInt()){
                                int modelNo = scanner.nextInt();
                                scanner.nextLine();
                                editor3D.del3DModel(modelNo);
                            }
                            break;
                        default:
...
class Editor3D implements UILayer{
    ...
    public void del3DModel(int id) {
        ...
        databaseAccess.removeEntity(delModel);
